...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_imagesloaded__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_animejs__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_flickity_dist_flickity_css__ = __webpack_require__(24);
...
(function () {
    ...
    $('.location-page-tabs-header-list').on('click', 'li:not(.active)', function () {
        $(this).addClass('active').siblings().removeClass('active').closest('.location-page-tabs', '').find('.location-page-tabs-body-item').removeClass('active').eq($(this).index()).addClass('active');
    });
})(jQuery);
...
if (services) {
    {
        ...
        var Slideshow = function () {
            ...
            _createClass(Slideshow, [{
                ...
                value: function createFrame() {
                    ...
                    this.DOM.svg.innerHTML = '\n                <defs>\n                <linearGradient id="gradient1" x1="0%" y1="0%" x2="0%" y2="100%">\n                    <stop offset="0%" stop-color="#1b2321"/>\n                    <stop offset="100%" stop-color="#171e1c"/>\n                </linearGradient>\n                </defs>\n                <path fill="' + this.settings.frameFill + '" d="' + this.paths.initial + '"/>';
                    ...
                    var animateSlides = function animateSlides() {
                        return new Promise(function (resolve, reject) {
                            ...
                            __WEBPACK_IMPORTED_MODULE_3_animejs___default()({
                                ...
                                translateY: dir === 'next' ? _this2.rect.height : -1 * _this2.rect.height,
                            ...
                            var currentTitleSlide = _this2.DOM.titlesSlides[_this2.current];
                            __WEBPACK_IMPORTED_MODULE_3_animejs___default()({
                            ...
                            __WEBPACK_IMPORTED_MODULE_3_animejs___default()({
                                ...
                                duration: _this2.settings.animation.slides.duration,
                                easing: _this2.settings.animation.slides.easing,
                                translateY: [dir === 'next' ? -1 * _this2.rect.height : _this2.rect.height, 0]
                            });
                            ...
                            __WEBPACK_IMPORTED_MODULE_3_animejs___default()({
                                targets: newSlideImg,
                                duration: _this2.settings.animation.slides.duration * 3,
                                easing: _this2.settings.animation.slides.easing,
                                translateY: [dir === 'next' ? -100 : 100, 0],
                                scale: [0.2, 1]
                            });

                            var newTitleSlide = _this2.DOM.titlesSlides[_this2.current];
                            newTitleSlide.classList.add('slide--current');
                            __WEBPACK_IMPORTED_MODULE_3_animejs___default()({
                                targets: newTitleSlide.children,
                                duration: _this2.settings.animation.slides.duration * 1.5,
                                easing: _this2.settings.animation.slides.easing,
                                delay: function delay(t, i, total) {
        ...
        __WEBPACK_IMPORTED_MODULE_2_imagesloaded___default()('.slide__img', {
            background: true
        }, function () {
