...
<section id="ratings-and-reviews">
    <div class="container position-relative">
        ...
        <!-- Ratings -->
        <div class="row">
            <div class="col-sm-10 col-lg-9 p-0">
                <h2 class="section-title pl-2">
                    Ratings and Reviews
                </h2>
        ...
        <div class="decor-img d-none d-xl-block" style="background-image: url('images/content/ratings-and-reviews/decor/decor-item-1.png');"></div>
    </div>
</section>