...
<body class="body-secondary">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <symbol id="share-icon" viewBox="0 0 473.932 473.932">
                ...
                <nav class="menu-nav">
                    ...
                    <div class="menu-nav-body text-center">
                        ...
                        <div class="menu-nav-body-contacts">
                            <div class="menu-nav-body-contacts-item">
                                <a href="#" class="menu-nav-body-contacts-item__link">1-800-362-8302</a>
                            </div>
                            <div class="menu-nav-body-contacts-item">
                                <a href="#" class="menu-nav-body-contacts-item__link">sales@ozonservices.com</a>
                            </div>
                        </div>
                    </div>
                    <div class="menu-nav-footer text-center">
                        <div class="menu-nav-footer-item">
